...
local parts = {
    eyes = {
        ...
        { id = 264, name = "Olhos Assustadores" },
    },
    nose = {
    ...
    mouth = {
        ...
        { id = 392, name = "Boca Assombrosa" },
    }
}
-- toca musica alien em loop
music(1, 0, 0, true)
...
-- 134:0030000000033333000033330000000000000000000000000000000000000000
-- 135:0000030033333000333300000000000000000000000000000000000000000000
...
-- <PATTERNS>
-- 000:
-- </PATTERNS>
